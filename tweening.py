...
class TimedValue():
    def __init__(self, v=0, duration=60, f='easeOutElastic', offset=0, delay=0, p=None, autoreset=False, inverted=False, bounce=False):
        """
...
class TimedBool():
    def __init__(self, delay=60, autoreset=False):
        """
